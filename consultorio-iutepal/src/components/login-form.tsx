                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <RecoverPasswordModal title='Recuperación de contraseña' messageBody="¿Olvidaste tu contraseña? ¡No te preocupes! Estamos aquí para ayudarte a recuperarla. Te enviaremos un mensaje al correo electrónico que utilizaste al registrarte. ">
                        <Button type='button' variant={'ghost'} className="font-medium text-gray-light">
