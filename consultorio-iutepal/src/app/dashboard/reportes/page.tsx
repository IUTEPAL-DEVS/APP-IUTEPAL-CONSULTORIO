...
import { chartConfigConsult, chartConfigEvents, chartConfigPathology, chartConfigPatient, chartConfigRecipe } from '@/src/lib/charts-config';
...
export default function Page() {
    ...
    return (
        <div className="grid grid-cols-3 gap-5">
            <ChartCard title="¿Cuantos pacientes se registraron en el año?" config={chartConfigPatient} data={chartData.patients} />
            <ChartCard title="¿Cuantas consultas se registraron en el año?" config={chartConfigConsult} data={chartData.consults} />
            <ChartCard title="¿Cuantas citas se registraron en el año?" config={chartConfigEvents} data={chartData.events} />
            <ChartCard title="¿Cuantos reposos se registraron en el año?" config={chartConfigRecipe} data={chartData.recipes} />
            <ChartCard title="¿Cuantas patologias se registraron en el año?" config={chartConfigPathology} data={chartData.pathologies} />
        </div>
    );
}